...
public static class FastConsole
{
    ...
    public static SafeFileHandle CreateOutputHandle()
    {
        ...
        var outputHandle = CreateFile("CONOUT$", 0x40000000, 2, IntPtr.Zero, FileMode.Open, 0, IntPtr.Zero);
    ...
    {
        outputHandle = CreateOutputHandle();
    }
